...
export default function Home() {
  return (
    <div className="min-h-screen w-full overflow-hidden relative">
      <div className="absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2 z-[999] px-4 sm:px-6 lg:px-8">
        <div className="text-left max-w-full sm:max-w-4xl mx-auto">
